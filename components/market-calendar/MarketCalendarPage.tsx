    ...
    <div className="flex flex-col w-full h-full bg-[#0f0f0f] overflow-hidden text-white/80">
      ...
      <div className="h-12 shrink-0 bg-[#0f0f0f] border-b border-white/[0.08] flex items-center gap-2 px-3">
        <div className="flex items-center gap-2 mr-2">
          ...
          <span className="text-[11px] font-bold text-white/60 uppercase tracking-widest">Market Calendar</span>
        </div>
          ...
          {IMPACT_LEVELS.map((level) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-2 py-1 text-[9px] font-bold uppercase rounded-md border transition-all ${
        ...
        <div className="relative shrink-0 ml-1">
          ...
          <input
            ...
            className="w-40 bg-white/[0.04] border border-white/[0.09] text-white/70 text-[10px] rounded-md pl-6 pr-6 py-1.5 focus:outline-none focus:border-white/[0.28] transition-all"
          />
          {search && (
        ...
        <button
          onClick={load}
          disabled={isLoading}
          className="flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-bold rounded-md bg-white/[0.07] border border-white/[0.12] text-white/70 hover:text-white hover:bg-white/[0.12] hover:border-white/[0.22] disabled:opacity-40 disabled:cursor-not-allowed transition-all active:scale-95 shrink-0"
        >
                    ...
                    {items.map((ev, i) => {
                      ...
                      return (
                        <div
                          ...
                          className={`grid grid-cols-[64px_52px_84px_1fr_76px_76px_76px] items-center gap-2 px-3 py-2 text-[11px] border-t border-white/[0.04] first:border-t-0 transition-colors hover:bg-white/[0.03] ${
                            isPast ? "opacity-50" : ""
