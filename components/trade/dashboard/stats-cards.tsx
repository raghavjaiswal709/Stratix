  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 md:gap-3">
      ...
      <div className="rounded-xl md:rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-600/10 to-blue-900/5 p-3 md:p-4 relative overflow-hidden">
        ...
        <p className="mt-1.5 text-[10px] md:text-[11px] uppercase tracking-wider text-white/40 font-medium">Total P&L</p>
        <p className={`text-[16px] md:text-[22px] font-bold mt-0.5 leading-tight ${totalPnL >= 0 ? "text-white" : "text-red-400"}`}>
          {fmt(totalPnL)}
        </p>
      ...
      {/* Unrealized */}
      <div className="rounded-xl md:rounded-2xl border border-white/7 bg-[#141720] p-3 md:p-4 relative overflow-hidden">
        ...
        <p className="text-[10px] md:text-[11px] uppercase tracking-wider text-white/40 font-medium">Unrealized</p>
        <p className={`text-[16px] md:text-[22px] font-bold mt-0.5 leading-tight ${unrealized >= 0 ? "text-white" : "text-red-400"}`}>
          {fmt(unrealized)}
        </p>
        <p className="text-[10px] md:text-[11px] text-white/30 mt-1">{openTrades} open</p>
      </div>
      ...
      <div className="rounded-xl md:rounded-2xl border border-white/7 bg-[#141720] p-3 md:p-4 relative overflow-hidden">
        ...
        <p className="text-[10px] md:text-[11px] uppercase tracking-wider text-white/40 font-medium">Realized</p>
        <p className={`text-[16px] md:text-[22px] font-bold mt-0.5 leading-tight ${realized >= 0 ? "text-white" : "text-red-400"}`}>
          {fmt(realized)}
        </p>
        <p className="text-[10px] md:text-[11px] text-white/30 mt-1">{closedTrades} closed</p>
      </div>
      ...
      <div className="rounded-xl md:rounded-2xl border border-white/7 bg-[#141720] p-3 md:p-4 relative overflow-hidden">
        ...
        <p className="text-[10px] md:text-[11px] uppercase tracking-wider text-white/40 font-medium">Win Rate</p>
        <p className="text-[16px] md:text-[22px] font-bold mt-0.5 leading-tight text-white">{winRate}%</p>
