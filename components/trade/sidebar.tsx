...
export function TradeSidebar() {
  ...
  return (
    <aside className="flex flex-col w-50 shrink-0 h-full bg-[#0f1117] border-r border-white/6">
      {/* Logo */}
      ...
      <nav className="flex-1 px-2 pt-4 space-y-0.5 overflow-y-auto">
        {/* Trading section */}
        <p className="px-2 mb-2 text-[10px] font-semibold uppercase tracking-widest text-white/25">
          Trading
        </p>
