...
const HOUR_OPTIONS = [
  { value: 6, label: "Last 6 Hours", sub: "Tight, most recent window" },
      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-3 p-5 border-b border-white/7">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] text-white/40 mt-0.5">
              {generating ? (progressLabel ?? "Gathering & analyzing…") : "Choose how far back to pull strictly ALL news"}
            </p>
          </div>
        ...
        {generating && (
          <div className="flex items-center gap-2 px-5 py-2.5 border-b border-white/7 bg-white/[0.02]">
            ...
            <span className="text-[11px] text-white/50 font-medium">Fetching every source, then scoring sentiment per instrument…</span>
          </div>
        )}
