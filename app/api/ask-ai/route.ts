...
function buildAskPrompt(instrument: string, candles: Candle1m[], articles: NewsItem[], userQuery: string): string {
...
export async function POST(req: NextRequest) {
  ...
  const prompt = buildAskPrompt(instrument, candles, enriched, query);
