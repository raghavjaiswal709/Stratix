...
export function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const paletteStyle: CSSProperties | undefined = palette
    ? ({
        ...
        "--muted": palette.muted ?? (palette.mode === "dark" ? "#161922" : "#f1f5f9"),
        "--muted-foreground": palette.textMuted,
        "--secondary": palette.secondary ?? (palette.mode === "dark" ? "#191c26" : "#f1f5f9"),
        "--secondary-foreground": palette.text,
        "--primary": palette.accent,
        "--primary-foreground": palette.mode === "dark" ? "#000000" : "#ffffff",
        "--ring": palette.accent,
        "--accent": `color-mix(in srgb, ${palette.accent} 12%, transparent)`,
        ...
        "--sidebar-primary-foreground": palette.mode === "dark" ? "#000000" : "#ffffff",
        "--sidebar-accent": `color-mix(in srgb, ${palette.accent} 12%, transparent)`,
